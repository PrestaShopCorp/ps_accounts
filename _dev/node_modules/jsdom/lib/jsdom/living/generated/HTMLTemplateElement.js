...
exports.create = function create(globalObject, constructorArgs, privateData) {
  ...
  const ctor = globalObject[ctorRegistry]["HTMLTemplateElement"];
  if (ctor === undefined) {
...
exports.install = function install(globalObject) {
  ...
  globalObject[ctorRegistry]["HTMLTemplateElement"] = HTMLTemplateElement;

  Object.defineProperty(globalObject, "HTMLTemplateElement", {
    configurable: true,
    writable: true,

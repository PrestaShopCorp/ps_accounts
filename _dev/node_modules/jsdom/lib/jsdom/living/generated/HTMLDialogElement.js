...
exports.create = function create(globalObject, constructorArgs, privateData) {
  ...
  const ctor = globalObject[ctorRegistry]["HTMLDialogElement"];
  if (ctor === undefined) {
...
exports.install = function install(globalObject) {
  ...
  globalObject[ctorRegistry]["HTMLDialogElement"] = HTMLDialogElement;

  Object.defineProperty(globalObject, "HTMLDialogElement", {
    configurable: true,
    writable: true,

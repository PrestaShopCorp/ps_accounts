...
exports.create = function create(globalObject, constructorArgs, privateData) {
  ...
  const ctor = globalObject[ctorRegistry]["HTMLTimeElement"];
  if (ctor === undefined) {
...
exports.install = function install(globalObject) {
  ...
  globalObject[ctorRegistry]["HTMLTimeElement"] = HTMLTimeElement;

  Object.defineProperty(globalObject, "HTMLTimeElement", {
    configurable: true,
    writable: true,

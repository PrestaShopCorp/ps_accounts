...
exports.create = function create(globalObject, constructorArgs, privateData) {
  ...
  const ctor = globalObject[ctorRegistry]["HTMLLabelElement"];
  if (ctor === undefined) {
...
exports.install = function install(globalObject) {
  ...
  globalObject[ctorRegistry]["HTMLLabelElement"] = HTMLLabelElement;

  Object.defineProperty(globalObject, "HTMLLabelElement", {
    configurable: true,
    writable: true,

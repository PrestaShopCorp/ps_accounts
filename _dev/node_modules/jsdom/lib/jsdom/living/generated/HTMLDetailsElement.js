...
exports.create = function create(globalObject, constructorArgs, privateData) {
  ...
  const ctor = globalObject[ctorRegistry]["HTMLDetailsElement"];
  if (ctor === undefined) {
...
exports.install = function install(globalObject) {
  ...
  globalObject[ctorRegistry]["HTMLDetailsElement"] = HTMLDetailsElement;

  Object.defineProperty(globalObject, "HTMLDetailsElement", {
    configurable: true,
    writable: true,

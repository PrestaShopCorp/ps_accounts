...
exports.create = function create(globalObject, constructorArgs, privateData) {
  ...
  const ctor = globalObject[ctorRegistry]["HTMLCollection"];
  if (ctor === undefined) {
...
exports.install = function install(globalObject) {
  ...
  globalObject[ctorRegistry]["HTMLCollection"] = HTMLCollection;

  Object.defineProperty(globalObject, "HTMLCollection", {
    configurable: true,
    writable: true,

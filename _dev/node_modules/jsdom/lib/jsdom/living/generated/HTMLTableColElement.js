...
exports.create = function create(globalObject, constructorArgs, privateData) {
  ...
  const ctor = globalObject[ctorRegistry]["HTMLTableColElement"];
  if (ctor === undefined) {
...
exports.install = function install(globalObject) {
  ...
  globalObject[ctorRegistry]["HTMLTableColElement"] = HTMLTableColElement;

  Object.defineProperty(globalObject, "HTMLTableColElement", {
    configurable: true,
    writable: true,

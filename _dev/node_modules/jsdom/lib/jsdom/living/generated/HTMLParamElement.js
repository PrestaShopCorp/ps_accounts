...
exports.create = function create(globalObject, constructorArgs, privateData) {
  ...
  const ctor = globalObject[ctorRegistry]["HTMLParamElement"];
  if (ctor === undefined) {
...
exports.install = function install(globalObject) {
  ...
  globalObject[ctorRegistry]["HTMLParamElement"] = HTMLParamElement;

  Object.defineProperty(globalObject, "HTMLParamElement", {
    configurable: true,
    writable: true,

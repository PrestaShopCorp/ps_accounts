...
exports.create = function create(globalObject, constructorArgs, privateData) {
  ...
  const ctor = globalObject[ctorRegistry]["HTMLDataElement"];
  if (ctor === undefined) {
...
exports.install = function install(globalObject) {
  ...
  globalObject[ctorRegistry]["HTMLDataElement"] = HTMLDataElement;

  Object.defineProperty(globalObject, "HTMLDataElement", {
    configurable: true,
    writable: true,

...
exports.create = function create(globalObject, constructorArgs, privateData) {
  ...
  const ctor = globalObject[ctorRegistry]["HTMLSpanElement"];
  if (ctor === undefined) {
...
exports.install = function install(globalObject) {
  ...
  globalObject[ctorRegistry]["HTMLSpanElement"] = HTMLSpanElement;

  Object.defineProperty(globalObject, "HTMLSpanElement", {
    configurable: true,
    writable: true,

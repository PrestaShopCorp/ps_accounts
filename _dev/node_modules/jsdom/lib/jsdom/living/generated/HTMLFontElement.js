...
exports.create = function create(globalObject, constructorArgs, privateData) {
  ...
  const ctor = globalObject[ctorRegistry]["HTMLFontElement"];
  if (ctor === undefined) {
...
exports.install = function install(globalObject) {
  ...
  globalObject[ctorRegistry]["HTMLFontElement"] = HTMLFontElement;

  Object.defineProperty(globalObject, "HTMLFontElement", {
    configurable: true,
    writable: true,

...
exports.create = function create(globalObject, constructorArgs, privateData) {
  ...
  const ctor = globalObject[ctorRegistry]["HTMLStyleElement"];
  if (ctor === undefined) {
...
exports.install = function install(globalObject) {
  ...
  globalObject[ctorRegistry]["HTMLStyleElement"] = HTMLStyleElement;

  Object.defineProperty(globalObject, "HTMLStyleElement", {
    configurable: true,
    writable: true,

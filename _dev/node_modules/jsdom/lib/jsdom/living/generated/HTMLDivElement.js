...
exports.create = function create(globalObject, constructorArgs, privateData) {
  ...
  const ctor = globalObject[ctorRegistry]["HTMLDivElement"];
  if (ctor === undefined) {
...
exports.install = function install(globalObject) {
  ...
  globalObject[ctorRegistry]["HTMLDivElement"] = HTMLDivElement;

  Object.defineProperty(globalObject, "HTMLDivElement", {
    configurable: true,
    writable: true,

...
exports.create = function create(globalObject, constructorArgs, privateData) {
  ...
  const ctor = globalObject[ctorRegistry]["HTMLTitleElement"];
  if (ctor === undefined) {
...
exports.install = function install(globalObject) {
  ...
  globalObject[ctorRegistry]["HTMLTitleElement"] = HTMLTitleElement;

  Object.defineProperty(globalObject, "HTMLTitleElement", {
    configurable: true,
    writable: true,

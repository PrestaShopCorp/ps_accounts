...
exports.create = function create(globalObject, constructorArgs, privateData) {
  ...
  const ctor = globalObject[ctorRegistry]["SVGTitleElement"];
  if (ctor === undefined) {
...
exports.install = function install(globalObject) {
  ...
  globalObject[ctorRegistry]["SVGTitleElement"] = SVGTitleElement;

  Object.defineProperty(globalObject, "SVGTitleElement", {
    configurable: true,
    writable: true,

...
exports.create = function create(globalObject, constructorArgs, privateData) {
  ...
  const ctor = globalObject[ctorRegistry]["HTMLMenuElement"];
  if (ctor === undefined) {
...
exports.install = function install(globalObject) {
  ...
  globalObject[ctorRegistry]["HTMLMenuElement"] = HTMLMenuElement;

  Object.defineProperty(globalObject, "HTMLMenuElement", {
    configurable: true,
    writable: true,

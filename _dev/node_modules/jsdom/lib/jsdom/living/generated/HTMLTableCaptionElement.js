...
exports.create = function create(globalObject, constructorArgs, privateData) {
  ...
  const ctor = globalObject[ctorRegistry]["HTMLTableCaptionElement"];
  if (ctor === undefined) {
...
exports.install = function install(globalObject) {
  ...
  globalObject[ctorRegistry]["HTMLTableCaptionElement"] = HTMLTableCaptionElement;

  Object.defineProperty(globalObject, "HTMLTableCaptionElement", {
    configurable: true,
    writable: true,

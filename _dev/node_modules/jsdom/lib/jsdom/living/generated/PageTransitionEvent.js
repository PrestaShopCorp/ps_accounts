...
exports.create = function create(globalObject, constructorArgs, privateData) {
  ...
  const ctor = globalObject[ctorRegistry]["PageTransitionEvent"];
  if (ctor === undefined) {
...
exports.install = function install(globalObject) {
  ...
  globalObject[ctorRegistry]["PageTransitionEvent"] = PageTransitionEvent;

  Object.defineProperty(globalObject, "PageTransitionEvent", {
    configurable: true,
    writable: true,

...
class HTMLHtmlElement extends HTMLElement.interface {
  ...
  get version() {
    ...
    const value = this[impl].getAttributeNS(null, "version");
  ...
  set version(V) {
    ...
    this[impl].setAttributeNS(null, "version", V);
  }
}
...
exports.create = function create(globalObject, constructorArgs, privateData) {
  ...
  const ctor = globalObject[ctorRegistry]["HTMLHtmlElement"];
  if (ctor === undefined) {
...
exports.install = function install(globalObject) {
  ...
  globalObject[ctorRegistry]["HTMLHtmlElement"] = HTMLHtmlElement;

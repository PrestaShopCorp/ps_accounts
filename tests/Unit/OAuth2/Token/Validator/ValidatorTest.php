...
use PrestaShop\Module\PsAccounts\OAuth2\Token\Validator\Exception\KidInvalidException;
...
use PrestaShop\Module\PsAccounts\Tests\Unit\OAuth2\TestCase;
...
JSON;
    ...
    protected function set_up()
    {
        ...
        $this->validator = new Validator($this->apiClient);
    }
    ...
    {
        $filename = $this->apiClient->getCachedJwks()->getFilename();

        $this->assertFalse(file_exists($filename));

        $this->apiClient->getJwks();

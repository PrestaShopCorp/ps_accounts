        ...
        $this->client = new Raven_Client(
            ...
            [
                ...
                'tags' => [
                    ...
                    'email' => $this->configuration->getUserFirebaseEmail(),
                    Configuration::PS_ACCOUNTS_SHOP_FIREBASE_ID_TOKEN => $this->configuration->getShopFirebaseIdToken(),
                    Configuration::PS_ACCOUNTS_SHOP_FIREBASE_REFRESH_TOKEN => $this->configuration->getShopFirebaseRefreshToken(),
                    Configuration::PS_ACCOUNTS_SHOP_FIREBASE_UUID => $this->configuration->getShopFirebaseUuid(),
                    Configuration::PS_ACCOUNTS_USER_FIREBASE_EMAIL_IS_VERIFIED => $this->configuration->userFirebaseEmailIsVerified(),
                    Configuration::PS_ACCOUNTS_USER_FIREBASE_EMAIL => $this->configuration->getUserFirebaseEmail(),

...
{
    // PS Shop Account
    const PS_ACCOUNTS_SHOP_FIREBASE_UUID = 'PSX_UUID_V4';
    const PS_ACCOUNTS_SHOP_FIREBASE_ID_TOKEN = 'PS_ACCOUNTS_FIREBASE_ID_TOKEN';
    const PS_ACCOUNTS_SHOP_FIREBASE_REFRESH_TOKEN = 'PS_ACCOUNTS_FIREBASE_REFRESH_TOKEN';

    // PS User Account
    const PS_ACCOUNTS_USER_FIREBASE_EMAIL = 'PS_ACCOUNTS_FIREBASE_EMAIL';
    const PS_ACCOUNTS_USER_FIREBASE_EMAIL_IS_VERIFIED = 'PS_ACCOUNTS_FIREBASE_EMAIL_IS_VERIFIED';

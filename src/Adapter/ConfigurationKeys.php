...
class ConfigurationKeys extends Enum
{
    ...
    const PS_ACCOUNTS_OAUTH2_REDIRECT_URI = 'PS_ACCOUNTS_OAUTH2_REDIRECT_URI';
    const PS_ACCOUNTS_OAUTH2_POST_LOGOUT_REDIRECT_URI = 'PS_ACCOUNTS_OAUTH2_POST_LOGOUT_REDIRECT_URI';

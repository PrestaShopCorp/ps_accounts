...
class CommandProvider implements IServiceProvider
{
    ...
    {
        $container->registerProvider(DeleteUserShopHandler::class, function () use ($container) {
        ...
        $container->registerProvider(LinkShopHandler::class, function () use ($container) {
            return new LinkShopHandler(
                $container->get(LinkShop::class)
            );
        });
        $container->registerProvider(UnlinkShopHandler::class, function () use ($container) {
        ...
        $container->registerProvider(UpdateUserShopHandler::class, function () use ($container) {
        ...
        $container->registerProvider(UpgradeModuleHandler::class, function () use ($container) {
        ...
        $container->registerProvider(UpgradeModuleMultiHandler::class, function () use ($container) {

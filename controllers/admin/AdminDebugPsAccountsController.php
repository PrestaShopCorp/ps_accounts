    ...
    public function initContent()
    {
        $this->context->smarty->assign([
            'config' => [
                ...
                'shopUuidV4' => $this->configuration->getShopFirebaseUuid(),
                'moduleVersion' => \Ps_accounts::VERSION,
                'psVersion' => _PS_VERSION_,
                'phpVersion' => phpversion(),
                'firebase_email' => $this->configuration->getUserFirebaseEmail(),
                'firebase_email_is_verified' => $this->configuration->userFirebaseEmailIsVerified(),
                'firebase_id_token' => $this->configuration->getShopFirebaseIdToken(),
                'firebase_refresh_token' => $this->configuration->getShopFirebaseRefreshToken(),
